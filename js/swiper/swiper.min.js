...
var Swiper = function() {
        ...
        updateSlides: function() {
            ...
            for (let i = 0; i < u; i += 1) {
                ...
                !c[i] || "none" !== v(r, "display")) {
                    ...
                    (C - Math.min(e.params.slidesPerGroupSkip, C)) % e.params.slidesPerGroup == 0 && f.push(E),
                    m.push(E),
                    E = E + I + y),
                    e.virtualSize += I + y,
                    M = I,
    ...
    var z = {
        slideTo: function(e, t, s, i, r) {
            ...
            if (n.initialized && a !== p) {
                if (!n.allowSlideNext && (h ? w > n.translate && w > n.minTranslate() : w < n.translate && w < n.minTranslate()))
                    return !1;
    ...
    var G = {
        ...
        loopFix: function(e) {
            ...
            l.virtual && h.virtual.enabled)
                return s && (h.centeredSlides || 0 !== l.snapIndex ? h.centeredSlides && l.snapIndex < h.slidesPerView ? l.slideTo(l.virtual.slides.length + l.snapIndex, 0, !1, !0) : l.snapIndex === l.snapGrid.length - 1 && l.slideTo(l.virtual.slidesBefore, 0, !1, !0) : l.slideTo(l.virtual.slides.length, 0, !1, !0)),
                l.allowSlidePrev = c,
                l.allowSlideNext = p,
                void l.emit("loopFix");
            let v = h.slidesPerView;
            "auto" === v ? v = l.slidesPerViewDynamic() : (v = Math.ceil(parseFloat(h.slidesPerView, 10)),
            m && v % 2 == 0 && (v += 1));
            ...
            l.recalcSlides(),
            "auto" === h.slidesPerView ? l.updateSlides() : S && (T.length > 0 && E || b.length > 0 && y) && l.slides.forEach(( (e, t) => {
            ...
            s)
                if (T.length > 0 && E) {
                    if (void 0 === t) {
                        ...
                        o ? l.setTranslate(l.translate - t) : (l.slideTo(x + Math.ceil(M), 0, !1, !0),
                    ...
                    if (void 0 === t) {
                        ...
                        o ? l.setTranslate(l.translate - t) : (l.slideTo(x - C, 0, !1, !0),
                        r && (l.touchEventsData.startTranslate = l.touchEventsData.startTranslate - t,
                        l.touchEventsData.currentTranslate = l.touchEventsData.currentTranslate - t))
                    } else {
    ...
    function V(e) {
        ...
        if (n.touchReleaseOnEdges && !n.loop)
            if (s.isVertical()) {
                if (h < a.startY && s.translate <= s.maxTranslate() || h > a.startY && s.translate >= s.minTranslate())
                    ...
                    void (r.isMoved = !1)
            } else if (u < a.startX && s.translate <= s.maxTranslate() || u > a.startX && s.translate >= s.minTranslate())
                return;
        ...
        if (void 0 === r.isScrolling) {
            let e;
            s.isHorizontal() && a.currentY === a.startY || s.isVertical() && a.currentX === a.startX ? r.isScrolling = !1 : f * f + m * m >= 25 && (e = 180 * Math.atan2(Math.abs(m), Math.abs(f)) / Math.PI,
        ...
        if ((new Date).getTime(),
        r.isMoved && r.allowThresholdMove && w !== s.touchesDirection && S && T && Math.abs(v) >= 1)
        ...
        v > 0 ? (S && T && r.allowThresholdMove && r.currentTranslate > (n.centeredSlides ? s.minTranslate() - s.slidesSizesGrid[s.activeIndex + 1] : s.minTranslate()) && s.loopFix({
            direction: "prev",
            setTranslate: !0,
            activeSlideIndex: 0
        }),
        r.currentTranslate > s.minTranslate() && (b = !1,
        n.resistance && (r.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + r.startTranslate + v) ** x))) : v < 0 && (S && T && r.allowThresholdMove && r.currentTranslate < (n.centeredSlides ? s.maxTranslate() + s.slidesSizesGrid[s.slidesSizesGrid.length - 1] : s.maxTranslate()) && s.loopFix({
            direction: "next",
            setTranslate: !0,
    ...
    function N(e) {
        ...
        if (t.allowClick) {
            ...
            t.emit("tap click", r),
            h < 300 && u - s.lastClickTime < 300 && t.emit("doubleTap doubleClick", r)
        }
        ...
        s.isMoved = !1,
        s.startMoving = !1,
        f = n.followFinger ? d ? t.translate : -t.translate : -s.currentTranslate,
        n.cssMode)
            return;
        ...
        for (let e = 0; e < c.length; e += e < n.slidesPerGroupSkip ? 1 : n.slidesPerGroup) {
            ...
            void 0 !== c[e + t] ? (m || f >= c[e] && f < c[e + t]) && (v = e,
            g = c[e + t] - c[e]) : (m || f >= c[e]) && (v = e,
